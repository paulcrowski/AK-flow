    ...
    <div className="hidden xl:flex w-[280px] shrink-0 h-full border-r border-gray-800 bg-[#07090d] flex-col relative z-10 overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden flex flex-col min-h-0">
        <button
          ...
          className="p-4 border-b border-gray-800 bg-[#0a0c10]/40 shrink-0 flex items-center justify-between"
          title="Tematy"
        >
          <div className="flex items-center gap-2">
          ...
          {topicsOpen ? <ChevronUp size={14} className="text-gray-500" /> : <ChevronDown size={14} className="text-gray-500" />}
        </button>
